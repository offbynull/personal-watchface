...
personalWatchfaceApp.controller('SportModeCtrl', ['MainService', '$scope', function(MainService, $scope) {
	...
	$scope.$on('main:heartRateChanged', function(event, data) {
		...
		if (data == 0) {
			...
			if (hrmFailCount % 200 == 0) {
				MainService.stopHeartrate();
				MainService.startHeartrate();
			}
